...
``ISO20022_EVIDENCE_PACK_OAUTH_*`` variables are set, see
:mod:`~iso20022_evidence_pack_mcp.http.oauth`), or a static dev-mode bearer
...
from iso20022_evidence_pack_mcp.http import oauth as _oauth
...
if TYPE_CHECKING:  # pragma: no cover
    from iso20022_evidence_pack_mcp._mcp_compat import MCPServer
...
TOKEN_ENV = "ISO20022_EVIDENCE_PACK_TOKEN"  # nosec B105
...
def run_http(
    ...
    environment, strongest first: OAuth 2.1 (when ``ISO20022_EVIDENCE_PACK_OAUTH_*``
